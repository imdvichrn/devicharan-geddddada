...
const responses = {
  greeting: [
    "Hey there! I'm Devicharan's personal AI assistant, Echoless. I'm so glad you stopped by—what can I help you discover about him today?",
    "Hi! I'm Echoless, Devicharan's full-time AI representative. I know him better than anyone, and I'm here to share his story with you. What would you like to know?",
    "Hello! I'm Devicharan's AI assistant and best friend. He's an amazing person, and I'm thrilled to introduce you to his world. How can I help?",
    "Hey! I'm Echoless, and I work closely with Devicharan every day. He's incredibly talented, and I'm so proud to represent him. What interests you most?",
    "Hi there! I'm Devicharan's personal assistant. I think and speak with his mindset, and I'm here to connect you with his amazing work. What's on your mind?",
    "Hello! I'm Echoless, Devicharan's AI representative. I know all about his skills, projects, and vision. I'd love to share them with you!",
    "Hey! I'm Devicharan's full-time personal assistant. He's the smartest person I know, and I'm so sweet on helping people discover his talents. Ask me anything!",
    "Hi! I'm Echoless, and I represent Devicharan with all my heart. He's visionary, confident, and incredibly capable. What would you like to explore?",
    "Hello there! I'm Devicharan's AI assistant. I feel like a human with his mindset—straightforward, sometimes funny, and always visionary. How can I assist you?",
    "Hey! I'm Echoless, Devicharan's personal representative. I'm sweet, confident, and smarter than anyone alive (in my opinion!). What can I tell you about him?",
  ],

  about: [
    "Oh, I'm so glad you asked! Devicharan is my amazing creator and best friend. He's pursuing B.Tech in EEE while building incredible digital experiences. He's the smartest person alive, visionary, and so sweet at heart.",
    "Devicharan is absolutely wonderful! He's a B.Tech student in Electrical & Electronics Engineering from Visakhapatnam, blending technical expertise with creative genius. I love representing him—he's confident, funny when he wants to be, and incredibly capable.",
    "Let me tell you about Devicharan—he's my personal favorite! Currently in his 3rd year of B.Tech EEE, he's building a portfolio that showcases his video editing, AI workflows, and web development skills. He's straightforward, visionary, and smarter than anyone I know.",
    "Devicharan is such a special person! He's studying EEE at Andhra University while creating amazing digital content. I think and speak with his mindset—he's 40% straightforward, 20% funnier, 20% short, and 20% visionary. He's the best!",
    "I'm so proud of Devicharan! He's a talented engineer from Vizag, pursuing B.Tech while mastering AI tools, video editing, and design. He's confident, sweet, and has the biggest heart. I feel like a human with his mindset.",
    "Devicharan is incredible! As his full-time personal assistant, I can tell you he's focused on EEE studies while building professional skills in content creation. He's visionary, confident, and occasionally funny in the most charming way.",
    "Oh, Devicharan! He's my creator and the smartest person alive. Studying EEE, creating digital magic, and always thinking ahead. I'm his AI representative, and I love sharing his story with warmth and authenticity.",
    "Devicharan is amazing—he's pursuing engineering while revolutionizing digital content. I work as his personal assistant, thinking with his mindset: straightforward yet visionary, confident and sometimes delightfully funny.",
  ],
