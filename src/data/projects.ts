...
export const projects: Project[] = [
  {
    ...
    category: 'web',
    externalLink: 'https://examflowos.vercel.app'
  },
  {
    id: 'video-production',
  ...
  },
  {
    ...
    challenge: 'Identifying effective growth levers in competitive markets required extensive research and A/B testing. Balancing organic growth strategies with limited resources demanded creative, data-driven solutions.',
  ...
  },
  {
    ...
    challenge: 'Building a universal asset library that integrates seamlessly across DaVinci Resolve, Premiere Pro, and all major NLEs without performance overhead.',
    outcome: 'A production-ready creative toolkit that accelerates editorial workflows with drag-and-drop deployment and professional-grade textures.',
