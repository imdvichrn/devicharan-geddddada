  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "siri-pulse": "siri-pulse 4s ease-in-out infinite",
        "siri-flow": "siri-flow 6s linear infinite",
        "siri-ripple": "siri-ripple 3s ease-in-out infinite",
        "siri-glow": "siri-glow 2s ease-in-out infinite"
      },
      backdropBlur: {
        xs: "2px",
      },
